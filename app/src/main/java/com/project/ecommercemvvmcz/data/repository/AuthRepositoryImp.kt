package com.project.ecommercemvvmcz.data.repository
...
import com.project.ecommercemvvmcz.util.FireStoreCollection
                ...
                if (it.isSuccessful){
                    ...
                    updateUserInfo(user) { state ->
                        when(state){
                            ...
                            is UiState.Failure -> {
                                result.invoke(UiState.Failure(state.message))
                            }
